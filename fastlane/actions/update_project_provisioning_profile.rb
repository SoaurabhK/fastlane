...
module Fastlane
  module Actions
    ...
    class UpdateProjectProvisioningProfileAction < Action
      ...
      def self.run(params)
        ...
        project.targets.each do |target|
          ...
          target.build_configuration_list.build_configurations.each do |build_configuration|
            ...
            sdk_pattern = "iphoneos*"
            build_configuration.build_settings["CODE_SIGN_IDENTITY[sdk=" + sdk_pattern + "]"] = "iPhone Distribution"
            build_configuration.build_settings["PROVISIONING_PROFILE_SPECIFIER"] = data["UUID"]
          end
        end
